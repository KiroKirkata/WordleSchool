...
namespace Wordle
{
    ...
    {
        private const string WordsTextFile = @"C:\Users\Kiril Lambovski\Desktop\GitHub\Game-Of-Life\Wordle\Wordle\WordleForm\WordleForm\wordsForWordle.txt";  // wordsForWordle.txt
